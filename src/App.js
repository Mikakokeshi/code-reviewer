...
import Markdown from "react-markdown";
  ...
  const prompt = "あなたは20年以上のキャリアがあるフルスタックエンジニアです。今から渡されるコードの・問題点の指摘・問題点を修正し、より簡潔にしたコード・修正点の説明をそれぞれ別々でMarkdown形式、かつタイトル部分を####で出力してください。問題点の指摘や修正点の説明は、プログラミング初心者にもわかるよう、背景を詳しく説明してください。";
    ...
    <div className="min-h-screen bg-blue-100 flex flex-col items-center justify-center">
      ...
      <main className="flex w-full max-w-5xl bg-white rounded-lg shadow-xl overflow-hidden h-[70vh]">
        ...
        <div className="flex flex-col w-1/2 h-full items-center justify-center">
          <div className="p-4 overflow-y-auto w-full">{ isLoading? (
            'レビュー中'
            ): (
